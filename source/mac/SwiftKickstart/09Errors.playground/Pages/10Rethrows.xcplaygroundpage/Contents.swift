...
func handleExample(_ value: Int,
                   using f: (Int) throws -> String) -> String {
  do {
...
func rethrowsExample(_ value: Int,
                     using f: (Int) throws -> String)
                                    rethrows -> String {
  try f(value)
}

try? rethrowsExample(3, using: Forecast.number)
try? rethrowsExample(20, using: Forecast.number)
try? rethrowsExample(-2, using: Forecast.number)
